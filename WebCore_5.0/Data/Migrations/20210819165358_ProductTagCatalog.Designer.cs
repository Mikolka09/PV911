...
namespace WebCore_5._0.Data.Migrations
{
    ...
    [Migration("20210819165358_ProductTagCatalog")]
    partial class ProductTagCatalog
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductTag", b =>
                {
                    ...
                    b.ToTable("PivotProductTags");
                });

            modelBuilder.Entity("WebCore_5._0.Entities.Catalog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebCore_5._0.Entities.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebCore_5._0.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebCore_5._0.Models.MyUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ProductTag", b =>
                {
                    b.HasOne("WebCore_5._0.Entities.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebCore_5._0.Entities.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebCore_5._0.Entities.Catalog", b =>
                {
                    b.HasOne("WebCore_5._0.Entities.Catalog", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("WebCore_5._0.Entities.Post", b =>
                {
                    b.HasOne("WebCore_5._0.Entities.Category", "Category")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("WebCore_5._0.Entities.Product", b =>
                {
                    b.HasOne("WebCore_5._0.Entities.Vendor", "Vendor")
                        .WithMany("Products")
