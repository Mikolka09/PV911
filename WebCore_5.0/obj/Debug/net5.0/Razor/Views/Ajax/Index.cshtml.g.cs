#pragma checksum "D:\Users\MIKOLKA\PV911\WebCore_5.0\Views\Ajax\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7bd2f4710ad87337846db9892933c342ff905adb"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7bd2f4710ad87337846db9892933c342ff905adb", @"/Views/Ajax/Index.cshtml")]
...
<script>
    ...
    document.getElementById(""btnCreateG"").onclick = function () {
        ...
        fetch(""/api/Groupps"", {
           ...
           ");
            WriteLiteral(@" .then(response => response.json()) // Преобразуем ответ в json
 ...
 ");
            WriteLiteral(@"                   let name = document.getElementById(""editNowNameG"").value;
    ...
    function fetchGetGroups() {
        fetch(""/api/Groupps"") // Пошлем запрос GET (по умолчанию) по марштуру на сервер
         ...
         ");
            WriteLiteral(@"   .catch((ex) => { // обрабатываем возможную ошибку
                console.log(""Error: "" + ex.message);
                console.log(""Response: "" + ex.response);
            });
    }
