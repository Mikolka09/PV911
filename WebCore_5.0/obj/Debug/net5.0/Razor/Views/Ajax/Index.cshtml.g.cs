#pragma checksum "D:\Users\MIKOLKA\PV911\WebCore_5.0\Views\Ajax\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5ebd0c52ed105a96c3a093139c987eece532fba2"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5ebd0c52ed105a96c3a093139c987eece532fba2", @"/Views/Ajax/Index.cshtml")]
...
<div style=""display: flex; justify-content: space-between; align-items: start;"">
    ...
    <div>
        ...
        <section id=""newStudent"">
            ");
            WriteLiteral(@"<input type=""text"" id=""newStudentName"" />
...
<script>
    ...
    function renderTeachersList(json) {
       ...
       ");
            ...
            span.appendChild(a);
            l");
            WriteLiteral(@"i.appendChild(span);
            ul.appendChild(li);
        }
...
<script>
    ...
    document.getElementById(""btnCreateG"").onclick = function () {
        let newGroup = {
            id: 0,
            name: document.getElementById(""newGroupName"").");
            WriteLiteral(@"value,
            ...
            a.onclick = function () {
                fetch(""/api/Groupps/"" + this.id, {
                    ...
                    .catch((ex) => { // обрабатываем возможную ошибку
                        console.log(""Error: "" + ex.message);
  ");
            WriteLiteral(@"                      console.log(""Response: "" + ex.response);
                    });
            }
            span.appendChild(a);
...
<script>
    ...
    function renderStudentsList(json) {
        ...
        ");
            WriteLiteral(@"    spanG.innerText = ""  ("" + json[i].group + "", "" + json[i].teacher + "")"";
    ...
    function fetchGetStudents() {
        fetch(""/api/St");
            WriteLiteral(@"udents"") // Пошлем запрос GET (по умолчанию) по марштуру на сервер
            .then(response => response.json()) // Преобразуем ответ в json
